...
def _get_dataset_filename(dataset_dir, split_name, shard_id):
  output_filename = 'mnist_eo_%s_%05d-of-%05d.tfrecord' % (
...
def run(dataset_dir):
  ...
  # 사진 섞는 것 주석 처리! > reuse! because bias of train dataset!
  ...
  _convert_dataset('train', training_filenames, class_names_to_ids,
                   dataset_dir)
  _convert_dataset('test', validation_filenames, class_names_to_ids,
                   dataset_dir)
